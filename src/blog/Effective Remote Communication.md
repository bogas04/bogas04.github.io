...
![Image comparing how synchronously processes stall the pipeline while asynchronous processes do not do so](/gallery/blog/asynchronous-vs-synchronous/display.webp)
